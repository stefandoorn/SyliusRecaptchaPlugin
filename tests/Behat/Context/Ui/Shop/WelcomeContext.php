...
namespace Tests\StefanDoorn\SyliusRecaptchaPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\StefanDoorn\SyliusRecaptchaPlugin\Behat\Page\Shop\WelcomePageInterface;
